      ...
      >
        ...
        <AnimatePresence>
          {hoverPreview && showHoverTooltip && !isPressed && (
            ...
            >
              <span
                className={cn("text-[12px] text-background tabular-nums whitespace-nowrap bg-white px-2 py-1", shape.bg)}
                style={{ fontVariationSettings: fontWeights.medium }}
              >
                {formatValue(hoverPreview.snappedValue)}
              </span>
      ...
      >
        ...
        {variant === "pips" && (
          <div className="absolute inset-0 flex items-center px-2 z-[2] pointer-events-none" aria-hidden>
            ...
            <span
              className="text-[13px] tabular-nums ml-auto px-2 bg-[#0e0e0e] text-transparent select-none"
          ...
          <div className="absolute inset-0 flex items-center px-2 z-[4] pointer-events-none">
            {label && (
              <motion.span
                ...
                initial={false}
                animate={{ color: isActive ? "#bfbfbf" : "var(--muted-foreground)" }}
                transition={spring.fast}
              >
                {label}
              </motion.span>
            ...
            <motion.span
              className="text-[14px] tabular-nums ml-auto px-2"
              initial={false}
